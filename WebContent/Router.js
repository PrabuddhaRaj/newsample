...
jQuery.sap.declare("demo_content.MaintainIT.WebContent.Router");

demo_content.MaintainIT.WebContent.Router = {
	//sap.ui.core.routing.Router.extend("demo_content.MaintainIT.WebContent.Router", {
